...
('Francesco','$2y$10$frscopasshash','CM','Ski'),
('Samuele','$2y$10$samuelepass','STU','Ski'),
('Ari','$2y$10$aripass','CM','Ski'),
('Luca','$2y$10$lucapass','CL','Ski'),
('Marta','$2y$10$martapass','VP','Ski'),
('Giorgie','$2y$10$giorgiepass','CM','Basketball'),
('Ayoub','$2y$10$ayoubpass','CL','Basketball'),
('Hana','$2y$10$hanapass','VP','Basketball'),
('Marco_b','$2y$10$marcob','CM','Basketball'),
('Sophia','$2y$10$sophiapass','STU',NULL),
('Noah','$2y$10$noahpass','CL','Robotics'),
('Isabella','$2y$10$isapass','VP','Robotics'),
('Kai','$2y$10$kaipass','CM','Robotics'),
('Emma','$2y$10$emmapass','STU','Robotics'),
('Oliver','$2y$10$olipass','CM',NULL),
('Clara','$2y$10$clarapass','CL','Book'),
('David','$2y$10$davidpass','VP','Book'),
('Sara','$2y$10$sarapass','CM','Book'),
('Paul','$2y$10$paulpass','STU',NULL),
('Nina','$2y$10$ninapass','CM','Book'),
('Mike','$2y$10$mikepass','CL','Photography'),
('Elena','$2y$10$elenapass','VP','Photography'),
('Tomas','$2y$10$tomaspass','CM','Photography'),
('Zoe','$2y$10$zoepass','STU','Photography'),
('Ivan','$2y$10$ivanpass','CM',NULL),
('Sofia','$2y$10$sofiapass','CL','Cooking'),
('Raoul','$2y$10$raoulpass','VP','Cooking'),
('Lena','$2y$10$lenapass','CM','Cooking'),
('Ben','$2y$10$benpass','STU',NULL),
('Yasmin','$2y$10$yasminpass','CM','Cooking'),
('Olga','$2y$10$olgapass','CL','Music'),
('Christian','$2y$10$christian','VP','Music'),
('Karen','$2y$10$karenpass','CM','Music'),
('Matt','$2y$10$mattpass','STU','Music'),
('Daria','$2y$10$dariapass','CM',NULL),
('Arthur','$2y$10$arthurpass','CL','Chess'),
('Bea','$2y$10$beapass','VP','Chess'),
('Zach','$2y$10$zachpass','CM','Chess'),
('Oliver_q','$2y$10$oliverq','STU',NULL),
('Paula','$2y$10$paulapass','CM','Chess'),
('Sylvia','$2y$10$sylviapass','CL','Hiking'),
('Jorge','$2y$10$jorgepass','VP','Hiking'),
('Mina','$2y$10$minapass','CM','Hiking'),
('Kevin','$2y$10$kevinpass','STU','Hiking'),
('Robin','$2y$10$robinpass','CM',NULL),
('Alex','$2y$10$alexpass','CL','Gaming'),
('Bella','$2y$10$bellapass','VP','Gaming'),
('Chris','$2y$10$chrispass','CM','Gaming'),
('Nora','$2y$10$norapass','STU','Gaming'),
('Quentin','$2y$10$quentinpass','CM',NULL),
('Mussolini','$2y$10$mussolini','STU',NULL),
('Giorgia','$2y$10$giorgia','STU',NULL),
('Sandra','$2y$10$sandrapass','CM',NULL),
('Leo','$2y$10$leopass','STU',NULL),
('Martin','$2y$10$martinpass','CM',NULL),
('Fernanda','$2y$10$fernandapass','STU','Ski'),
('Igor','$2y$10$igorpass','CM','Ski'),
('Yvonne','$2y$10$yvonnepass','STU','Basketball'),
('Harry','$2y$10$harrypass','CM','Basketball'),
('Eva','$2y$10$evapass','STU','Hiking');
